...
class Order(models.Model):
    ...
    total_price = models.DecimalField(max_digits=5, decimal_places=2, default=0)  # total price for all products
...
class ProductInOrder(models.Model):
    ...
    price_per_item = models.DecimalField(max_digits=5, decimal_places=2, default=0)
    total_price = models.DecimalField(max_digits=5, decimal_places=2, default=0) #price*nmb
    is_active = models.BooleanField(default=True)
    created = models.DateTimeField(auto_now_add=True, auto_now=False)
    updated = models.DateTimeField(auto_now_add=False, auto_now=True)
